...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { title: 'Certificates', icon: <IconTrophy className="h-full w-full" />, href: '#achievements', onClick: (e: React.MouseEvent) => { e.preventDefault(); handleNavigation('achievements'); } },
