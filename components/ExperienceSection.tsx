              ...
              <div className={`w-full flex ${index % 2 !== 0 ? 'md:justify-end' : 'md:justify-start'}`}>
                <div className="w-full md:w-5/12 pl-12 md:pl-0">
                  ...
                  >
                    ...
                    <p className="experience-card-date relative z-10 text-sm font-semibold mb-1">{item.date}</p>
                    <h3 className="experience-card-title relative z-10 font-heading text-xl font-bold mb-2">{item.title}</h3>
                    <p className="experience-card-institution relative z-10 text-sm font-semibold">{item.institution}</p>
                    {item.description && (
                      <p className="experience-card-description relative z-10 text-sm mt-3 leading-relaxed">{item.description}</p>
                    )}
                  </motion.div>
                </div>
              </div>
