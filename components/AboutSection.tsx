          ...
          <div className="relative bg-black/40 dark:bg-black/60 backdrop-blur-xl rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-center md:items-start gap-10 border border-white/10 dark:border-white/10">
            ...
            <div className="flex flex-col items-center text-center gap-4 flex-shrink-0">
              ...
              <span className="px-3 py-1 text-xs bg-gradient-to-r from-gray-700 to-black dark:from-gray-300 dark:to-white text-white dark:text-black rounded-full font-semibold shadow-md mt-2">
                🚀 Currently exploring: ML and DSA
              </span>
            ...
            <div className="flex-1 flex flex-col gap-3 justify-center text-left">
              <div className="flex flex-col items-start mb-2">
                <span className="text-xl font-bold text-slate-900 dark:text-white text-left">Kothakota Dileep Kumar <span role="img" aria-label="brain">🧠</span></span>
                <span className="text-base font-medium text-slate-700 dark:text-slate-300 mt-1">AI Engineer Aspirant · Software Developer · Data Analytics Enthusiast</span>
              </div>
              <div className="flex flex-wrap gap-2 mb-3">
                <span className="bg-gray-700/10 text-gray-700 dark:bg-gray-700/30 dark:text-gray-200 px-3 py-1 rounded text-sm font-semibold">AI & Data Science</span>
                <span className="bg-gray-600/10 text-gray-600 dark:bg-gray-600/30 dark:text-gray-200 px-3 py-1 rounded text-sm font-semibold">Problem Solver</span>
                <span className="bg-gray-500/10 text-gray-500 dark:bg-gray-500/30 dark:text-gray-200 px-3 py-1 rounded text-sm font-semibold">Continuous Learner</span>
              </div>
              <div className="text-base text-slate-800 dark:text-slate-200 leading-relaxed space-y-3">
                <p>
                  I am a Computer Science Engineering student passionate about Artificial Intelligence, Software Development, and Data Analytics. My goal is to build intelligent systems that solve real-world problems while continuously growing as an engineer and innovator,I have a strong foundation in Python, SQL, Object-Oriented Programming, Data Structures, and DBMS, I enjoy developing data-driven solutions that transform raw information into meaningful insights and impactful applications.
                </p>
                <p>
                  My experience includes data analytics, forecasting, dashboard development, and machine learning projects. I am actively expanding my expertise in AI Engineering, modern software development, and scalable application design while preparing for industry opportunities.
                </p>
              </div>
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="bg-gray-700/10 text-gray-700 dark:bg-gray-700/30 dark:text-gray-200 px-3 py-1 rounded-full text-sm font-semibold">AI & Data Science Projects</span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 mt-3 text-slate-700 dark:text-slate-300 text-base font-medium">
                <div className="flex items-center gap-2 text-left text-sm md:text-base"><FaMapMarkerAlt className="text-light-text-primary dark:text-text-primary" /> Srikakulam, Andhra Pradesh, India</div>
                <div className="flex items-center gap-2 text-left text-sm md:text-base"><FaEnvelope className="text-light-text-primary dark:text-text-primary" /> kottakotadileepkumar5@gmail.com</div>
              </div>
